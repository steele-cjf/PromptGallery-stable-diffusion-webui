...
<div align="center">
  ...
  <p align="center">
    An prompt cookbook extenstion for stable-diffusion-webui. Start the journey!
    <br />
...
### Populate previews
  ...
  For instance we added two prompt-sets, we sould like to add preview pictures in Prompt-Gallery

  ![3-1](./images/3-1.JPG)

  Goto tab "txt2img" and Select "Prompt Gallery" in scripts

  ![3-2](./images/3-2.JPG)

  Upload yaml libray of avatar first and select avatar.
  ...
  QC the image quality

  ![3-6](./images/3-6.JPG)

  Checkout the new preview image from the prompt-set
...
- [x] Prompt Gallery
- [ ] Add UI for character and prompt-set creat/deletion
